...
const dict = {
  zh: {
    ...
    'lib.settings.sidebar': '库侧栏显示',
    'lib.settings.sidebar.hint': '仅影响侧栏库列表，不影响顶部切换菜单',
    'lib.settings.sidebar.short': '侧栏',
  ...
  en: {
    ...
    'lib.settings.sidebar': 'Show In Sidebar',
    'lib.settings.sidebar.hint': 'Only affects the sidebar list; the top switcher menu is unchanged',
    'lib.settings.sidebar.short': 'Sidebar',
